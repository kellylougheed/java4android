    ...
    */
    ...
    public double calculate(int size, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            // Store birthdays in a set
            Set birthdays = new HashSet();
            ...
            for (int j = 0; j < size; j++) {
                ...
                // Detect duplicates or add birthday to set
        ...
        // Calculate percentage of simulations with two birthdays

        double b = (double) twoBirthdays;
